...
def eval_policy(policy, env_name, seed, eval_episodes=10, eval_cnt=None):
	...
	print("[{}] Evaluation over {} episodes, Avg_Rewards: {} Avg_Harvest_Energy: {}".format(eval_cnt, eval_episodes, avg_reward, avg_reward/max(avg_received_energy, EPS)))

	return avg_reward, avg_reward/max(avg_received_energy, EPS)
