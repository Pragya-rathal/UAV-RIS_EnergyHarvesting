...
class FooEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward, radio_state, received_energy = self.env_state(step, tau, power_1, power_2, power_3, Theta_R, Omega_R)
        terminated = step == t - 1
        truncated = False
    ...
    def EH(self, tau, power_1, power_2, power_3, Theta_R, L_U, L_AP, Omega_R):
    ...
    def capacity (self, tau, power_1, power_2, power_3, Theta_R, L_U, L_AP, UT_0, UT_1, UT_2, Omega_R):
        ...
        SINR_2 = 10 * mt.log(((signal_UT_2 + 1e-14)/(AWGN)), 10)
        SINR_3 = 10 * mt.log(((signal_UT_3 + 1e-14)/(AWGN)), 10)
    ...
    def env_state(self, step, tau, power_1, power_2, power_3, Theta_R, Omega_R):
        ...
        reward, received_energy = self.EH(tau, power_1, power_2, power_3, Theta_R, L_U, L_AP, Omega_R)
        HarvestEnergy = reward
        Aver_Throughput = self.capacity (tau, power_1, power_2, power_3, Theta_R, L_U, L_AP, UT_0, UT_1, UT_2, Omega_R)
        decline = reward * 1/3
